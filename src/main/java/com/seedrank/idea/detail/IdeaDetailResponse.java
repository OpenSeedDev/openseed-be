...
public record IdeaDetailResponse(
    ...
    static IdeaDetailResponse full(Idea idea, List<ValidationQuestion> questions, long viewCount) {
        return new IdeaDetailResponse(
                ...
                idea.visibility(), idea.currentUnitPrice(), viewCount,
                idea.publishedAt(), idea.createdAt(), idea.updatedAt());
    }

    static IdeaDetailResponse semiPublicGuest(Idea idea, long viewCount) {
        return new IdeaDetailResponse(
                idea.id(), idea.status(), idea.title(), idea.category(), idea.summary(), idea.problem(),
                null, null, null, null,
                idea.visibility(), idea.currentUnitPrice(), viewCount,
    ...
    static IdeaDetailResponse summaryOnly(Idea idea, long viewCount) {
        return new IdeaDetailResponse(
